...
Lets start by creating our own raster from scratch. We can create rasters from scratch and load them from a file using the function `rast()`. We can create a simple raster by specifying the x and y limits for the raster and the resolution (how big is each rectangle)
